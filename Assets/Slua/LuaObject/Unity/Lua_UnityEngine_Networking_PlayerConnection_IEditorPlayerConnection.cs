...
public class Lua_UnityEngine_Networking_PlayerConnection_IEditorPlayerConnection : LuaObject {
	...
	static public int Register(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.Networking.PlayerConnection.IEditorPlayerConnection self=(UnityEngine.Networking.PlayerConnection.IEditorPlayerConnection)checkSelf(l);
			System.Guid a1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Networking.PlayerConnection.IEditorPlayerConnection");
		...
		addMember(l,Send);
		createTypeMetatable(l,null, typeof(UnityEngine.Networking.PlayerConnection.IEditorPlayerConnection));
	}
}
