	...
	public class BindUnity {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_UnityEngine_Networking_PlayerConnection_MessageEventArgs.reg,
				Lua_UnityEngine_Networking_PlayerConnection_IEditorPlayerConnection.reg,
				Lua_UnityEngine_ScriptableObject.reg,
				Lua_UnityEngine_Networking_PlayerConnection_PlayerConnection.reg,
				...
				Lua_UnityEngine_Networking_IMultipartFormSection.reg,
				Lua_UnityEngine_Networking_MultipartFormDataSection.reg,
				Lua_UnityEngine_Networking_MultipartFormFileSection.reg,
				Lua_UnityEngine_Networking_UnityWebRequestAsyncOperation.reg,
				Lua_UnityEngine_Networking_UnityWebRequest.reg,
				Lua_UnityEngine_WWWForm.reg,
				Lua_UnityEngine_Networking_CertificateHandler.reg,
				Lua_UnityEngine_Networking_DownloadHandler.reg,
				Lua_UnityEngine_Networking_DownloadHandlerBuffer.reg,
				Lua_UnityEngine_Networking_DownloadHandlerScript.reg,
				Lua_UnityEngine_Networking_DownloadHandlerFile.reg,
				Lua_UnityEngine_Networking_UploadHandler.reg,
				Lua_UnityEngine_Networking_UploadHandlerRaw.reg,
				Lua_UnityEngine_Networking_UploadHandlerFile.reg,
