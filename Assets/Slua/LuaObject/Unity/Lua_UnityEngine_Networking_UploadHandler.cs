...
public class Lua_UnityEngine_Networking_UploadHandler : LuaObject {
	...
	static public int Dispose(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.Networking.UploadHandler self=(UnityEngine.Networking.UploadHandler)checkSelf(l);
			self.Dispose();
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Networking.UploadHandler");
		addMember(l,Dispose);
		...
		createTypeMetatable(l,null, typeof(UnityEngine.Networking.UploadHandler));
	}
}
