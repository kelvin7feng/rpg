...
public class Lua_UnityEngine_Networking_IMultipartFormSection : LuaObject {
	...
	static public int get_sectionName(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.Networking.IMultipartFormSection self=(UnityEngine.Networking.IMultipartFormSection)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Networking.IMultipartFormSection");
		...
		createTypeMetatable(l,null, typeof(UnityEngine.Networking.IMultipartFormSection));
	}
}
