...
public class Lua_KG_LuaBaseCondition : LuaObject {
	...
	static public int get_isChecked(IntPtr l) {
		try {
			...
			#endif
			#endif
			KG.LuaBaseCondition self=(KG.LuaBaseCondition)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"KG.LuaBaseCondition");
		addMember(l,"isChecked",get_isChecked,set_isChecked,true);
		addMember(l,"Agent",get_Agent,null,true);
		createTypeMetatable(l,null, typeof(KG.LuaBaseCondition),typeof(NodeCanvas.Framework.ConditionTask<UnityEngine.Transform>));
	}
}
