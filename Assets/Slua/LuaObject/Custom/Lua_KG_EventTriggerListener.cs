...
public class Lua_KG_EventTriggerListener : LuaObject {
	...
	static public int OnPointerEnter(IntPtr l) {
		try {
			...
			#endif
			#endif
			KG.EventTriggerListener self=(KG.EventTriggerListener)checkSelf(l);
	...
	static public int Get_s(IntPtr l) {
		try {
			...
			var ret=KG.EventTriggerListener.Get(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int set_onPointerEnter(IntPtr l) {
		try {
			...
			#endif
			KG.EventTriggerListener self=(KG.EventTriggerListener)checkSelf(l);
			KG.EventTriggerListener.PointerEventDelegate v;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onPointerDown(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onPointerUp(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onPointerClick(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			KG.EventTriggerListener.PointerEventDelegate v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.onPointerClick=v;
			else if(op==1) self.onPointerClick+=v;
			else if(op==2) self.onPointerClick-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onInitializePotentialDrag(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			KG.EventTriggerListener.PointerEventDelegate v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.onInitializePotentialDrag=v;
			else if(op==1) self.onInitializePotentialDrag+=v;
			else if(op==2) self.onInitializePotentialDrag-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onUpdateSelected(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			KG.EventTriggerListener self=(KG.EventTriggerListener)checkSelf(l);
			KG.EventTriggerListener.BaseEventDelegate v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.onUpdateSelected=v;
			else if(op==1) self.onUpdateSelected+=v;
			else if(op==2) self.onUpdateSelected-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onCancel(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			KG.EventTriggerListener.BaseEventDelegate v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.onCancel=v;
			else if(op==1) self.onCancel+=v;
			else if(op==2) self.onCancel-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int set_onMove(IntPtr l) {
		try {
			...
			#endif
			KG.EventTriggerListener self=(KG.EventTriggerListener)checkSelf(l);
			KG.EventTriggerListener.AxisEventDelegate v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"KG.EventTriggerListener");
		...
		addMember(l,Get_s);
		addMember(l,"onPointerEnter",null,set_onPointerEnter,true);
		addMember(l,"onPointerExit",null,set_onPointerExit,true);
		addMember(l,"onPointerDown",null,set_onPointerDown,true);
		addMember(l,"onPointerUp",null,set_onPointerUp,true);
		addMember(l,"onPointerClick",null,set_onPointerClick,true);
		addMember(l,"onInitializePotentialDrag",null,set_onInitializePotentialDrag,true);
		...
		addMember(l,"onUpdateSelected",null,set_onUpdateSelected,true);
		...
		addMember(l,"onCancel",null,set_onCancel,true);
		addMember(l,"onMove",null,set_onMove,true);
		createTypeMetatable(l,null, typeof(KG.EventTriggerListener),typeof(UnityEngine.EventSystems.EventTrigger));
	}
}
