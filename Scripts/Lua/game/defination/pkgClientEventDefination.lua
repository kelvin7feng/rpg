...
ON_PET_PLAY                 = "on_pet_play"
ON_PET_REST                 = "on_pet_rest"
ON_PET_ADD                  = "on_pet_add"
ON_BUY_PET                  = "on_buy_pet"
ON_UPDATE_TASK_INFO         = "on_update_task_info"
ON_UPDATE_ONE_TASK          = "on_update_one_task"
ON_GET_TASK_REWARD          = "on_get_task_reward"
ON_UPDATE_LIVENESS          = "on_update_liveness"